...
class ItemInfoContainer extends Component<ItemInfoContainerProps, ItemInfoContainerState> {
    ...
    componentDidMount() {
        EvolveeEnvironment.getGame().uiManager.onSelectFurni = this.showFurniView;
        EvolveeEnvironment.getGame().uiManager.onSelectUser = this.showUserView;
        EvolveeEnvironment.getGame().uiManager.onCloseSelectFurni = this.tryCloseFurniView;
        EvolveeEnvironment.getGame().uiManager.onCloseSelectUser = this.tryCloseUserView;
    }
