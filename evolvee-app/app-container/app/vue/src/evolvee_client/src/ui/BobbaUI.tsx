...
import AvatarInfo from '../evolvee/imagers/avatars/AvatarInfo';
...
class EvolveeUI extends Component<EvolveeUIProps, EvolveeUIState> {
    constructor(props: EvolveeUIProps) {
        super(props);
