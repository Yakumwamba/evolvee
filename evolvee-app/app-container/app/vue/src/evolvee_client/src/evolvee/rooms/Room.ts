...
export default class Room {
    ...
    chat(chat: string) {
        EvolveeEnvironment.getGame().communicationManager.sendMessage(new RequestChat(chat));
    }

    wave() {
        EvolveeEnvironment.getGame().communicationManager.sendMessage(new RequestWave());
    }
