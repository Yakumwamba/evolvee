...
import io.evolvee.poc.communication.outgoing.messenger.MessengerFriendsComposer;
import io.evolvee.poc.communication.outgoing.messenger.MessengerMessageComposer;
import io.evolvee.poc.communication.outgoing.messenger.MessengerRequestsComposer;
import io.evolvee.poc.communication.outgoing.messenger.MessengerSearchResultComposer;
import io.evolvee.poc.communication.outgoing.messenger.MessengerUpdateFriendComposer;
...
public class Messenger {
	...
	public void handleAcceptFriend(int userId) {
		User user = EvolveeEnvironment.getGame().getUserManager().getUser(userId);
	...
	public void handleFollowFriend(int userId) {
		...
		if (user != null && isFriendsWith(user) && user.isConnected()) {
			...
			if (currentRoom != null) {
				EvolveeEnvironment.getGame().getRoomManager().prepareRoomForUser(this.user,
