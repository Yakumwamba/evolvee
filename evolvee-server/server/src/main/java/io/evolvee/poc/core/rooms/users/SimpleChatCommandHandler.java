        ...
        try {
            switch (args[0].toLowerCase()) {
                ...
                case "spawn": {
                    ...
                    BaseItem item = EvolveeEnvironment.getGame().getItemManager().findItem(itemName);
                    if (item != null) {
                ...
                case "buy": {
                	 String itemName = args[1];
                     CatalogueItem item = EvolveeEnvironment.getGame().getCatalogue().findItem(itemName);
                     if (item != null) {
                    	 EvolveeEnvironment.getGame().getCatalogue().handlePurchase(currentUser.getUser(), item.getPageId(), item.getId());
                    	 return true;
                     }
                     return false;
                }
