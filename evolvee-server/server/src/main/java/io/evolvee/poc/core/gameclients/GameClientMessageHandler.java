...
import io.evolvee.poc.communication.incoming.catalogue.RequestCatalogueIndex;
import io.evolvee.poc.communication.incoming.catalogue.RequestCataloguePage;
import io.evolvee.poc.communication.incoming.catalogue.RequestCataloguePurchase;
import io.evolvee.poc.communication.incoming.messenger.RequestMessengerAcceptFriend;
import io.evolvee.poc.communication.incoming.messenger.RequestMessengerAddFriend;
import io.evolvee.poc.communication.incoming.messenger.RequestMessengerDenyFriend;
import io.evolvee.poc.communication.incoming.messenger.RequestMessengerFollowFriend;
import io.evolvee.poc.communication.incoming.messenger.RequestMessengerLoadFriends;
import io.evolvee.poc.communication.incoming.messenger.RequestMessengerRemoveFriend;
import io.evolvee.poc.communication.incoming.messenger.RequestMessengerSearchFriend;
import io.evolvee.poc.communication.incoming.messenger.RequestMessengerSendMessage;
import io.evolvee.poc.communication.incoming.navigator.RequestNavigatorCreateRoom;
import io.evolvee.poc.communication.incoming.navigator.RequestNavigatorGoToRoom;
import io.evolvee.poc.communication.incoming.navigator.RequestNavigatorLeaveRoom;
import io.evolvee.poc.communication.incoming.navigator.RequestNavigatorMakeFavourite;
import io.evolvee.poc.communication.incoming.navigator.RequestNavigatorOwnRooms;
import io.evolvee.poc.communication.incoming.navigator.RequestNavigatorPopularRooms;
import io.evolvee.poc.communication.incoming.navigator.RequestNavigatorRemoveFavourite;
import io.evolvee.poc.communication.incoming.navigator.RequestNavigatorSearchRooms;
import io.evolvee.poc.communication.incoming.roomdata.RequestHeightMap;
import io.evolvee.poc.communication.incoming.roomdata.RequestRoomData;
import io.evolvee.poc.communication.incoming.rooms.RequestChangeLooks;
import io.evolvee.poc.communication.incoming.rooms.RequestChangeMotto;
import io.evolvee.poc.communication.incoming.rooms.RequestChat;
import io.evolvee.poc.communication.incoming.rooms.RequestFurniInteract;
import io.evolvee.poc.communication.incoming.rooms.RequestFurniMovement;
import io.evolvee.poc.communication.incoming.rooms.RequestFurniPickUp;
import io.evolvee.poc.communication.incoming.rooms.RequestFurniPlace;
import io.evolvee.poc.communication.incoming.rooms.RequestLookAt;
import io.evolvee.poc.communication.incoming.rooms.RequestMovement;
import io.evolvee.poc.communication.incoming.rooms.RequestWave;
import io.evolvee.poc.communication.incoming.users.Login;
import io.evolvee.poc.communication.incoming.users.RequestGetInventory;
import io.evolvee.poc.communication.protocol.ClientMessage;
import io.evolvee.poc.communication.protocol.ClientOpCodes;
